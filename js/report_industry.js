...
(function whoReport($){
	...
	var firmigraphic_report = { 
		"reportDescription":{
			...
			// now handled when report is run
	      //   "dateFrom" : _from,
	      //	"dateTo" : _to,
	        "elements":[
	            { 
	...
	*/
		...
		//	hcHiddenTotals['visible'] = false;
			...
			var reportObj = window.analytics.reporting.types['wafer-industry-report'];
				...
				chart: {
					...
					events: {
		                drilldown: function (data) {
		                	...
		                	var newTitleVal = 'Top ' + howMany + ' Companies for ' + whichDrill
